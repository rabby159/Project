...
const Banner = () => {
  return (
    <section className="bg-gradient-to-r from-amber-50 via-amber-100 to-amber-50 w-full">
      <div className="flex justify-around items-center p-3 py-20 gap-5 max-w-7xl mx-auto">
        {/* Banner moto part */}
        <div className="flex-1">
          ...
          <Button className="py-7 bg-[#EE4E32] text-lg">
            Become a Merchant
          </Button>
        </div>
        {/* Banner image part */}
      ...
      <div className="bg-gradient-to-b from-[#fdf5e4] to-[#ffffff] h-20"></div>
    </section>
  );
};
